            ...
            <div class="right-content-wrap">
                <div class="card-item">
                    <div class="card-item-left">
                        ...
                        <div class="card-sliders-left-wrap">
                            ...
                            <div class="card-item-slider slider-nav">
                                <div class="slider-nav-item vfix-before">
                                    <img src="images/popular_item_1.png" alt="" />
                                </div>
                                <div class="slider-nav-item vfix-before">
                                    <img src="images/popular_item_2.png" alt="" />
                    ...
                    <div class="card-item-right">
                        <div class="card-item-right-wrap">
                            <div class="card-item-title">GNSS приемник Trimble R4 mega x-drive</div>
                            <div class="card-item-topInf">
                                <span class="active">Есть в наличии</span>
                                <span>Артикул: 8E10G-к</span>
                            </div>
                            <div class="card-item-old-price-wrap">
                                <div class="card-item-old-price">
                                    985 050 ,-
                                </div>
                            </div>
                            <div class="card-item-price-main-wrap">
                                <div class="card-item-price-main">
                                    788 099 ,-
                                </div>
                            ...
                            <div class="card-item-delivery-line">
                                <span class="icon delivery-icon point"></span>
                                <span class="delivery-text-decor">Самовывоз</span>
                                <span>Бесплатно</span>
                            </div>
                            <div class="card-item-delivery-line">
                ...
                <!-- similar -->
                <div class="card-item-similar-product card-tabs-sliders">
                    <div class="card-item-similar-product-wrap">
                        <div class="card-item-similar-product-title">
                            <span>Похожие товары </span>
                        </div>
                        <div class="card-tabs-sliders-main">
                            <div class="card-item-similar-products card-tabs-sliders-main-item active">
                                <div class="card-product-item">
                                    <div class="product-item">
                                        <div class="product-item-wrapper">
                                            <div class="product-item-top">
