<div class="main katalog-page katalog_brends">
        ...
        <div class="mbox">
                    ...
                    <div class="navigation_block_wrap">
                        <div class="nav-menu nav-column">
                            <ul>
                                ...
                                <li><a href="#"><span>Электронные теодолиты</span></a>
                                    <ul class="active">
            ...
            <div class="right-content-wrap">
                <div class="katalog-content">
                    ...
                    <div class="katalog_brends_items_wrap">
                        <div class="katalog_brends_items">
                            <div class="katalog_brends_row">
                                <div class="katalog_brends_item">
                                    <a href="#">
                                        <div class="katalog_brends_item_img"><img src="images/rgk_logo.png" alt=""></div>
                                        <div class="katalog_brends_item_text">RGK</div>
                                    </a>
                                </div>
                                <div class="katalog_brends_item">
                                    <a href="#">
                                        <div class="katalog_brends_item_img"><img src="images/katalog_brends_item_img_2.png"  alt=""></div>
                                        <div class="katalog_brends_item_text">VEGA</div>
                                    </a>
                                </div>
                                <div class="katalog_brends_item">
                                    <a href="#">
                                        <div class="katalog_brends_item_img"><img src="images/katalog_brends_item_img_3.png" alt=""></div>
                                        <div class="katalog_brends_item_text">Topcon</div>
                                    </a>
                                </div>
                                <div class="katalog_brends_item">
                                    <a href="#">
                                        <div class="katalog_brends_item_img"><img src="images/katalog_brends_item_img_4.png" alt=""></div>
                                        <div class="katalog_brends_item_text">CST/berger</div>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="katalog_products">
                        ...
                        <div class="product-items-wrap katalog-item grid">
                                ...
                                <div class="product-item">
                                    <div class="product-item-wrapper">
                                        <div class="product-item-top">
                                            <div class="product-item-img-wrap">
                                                <div class="product-item-img vfix-before">
                                                    <img src="images/popular_item_8.png" alt="" />
                                                </div>
                                            </div>
                                            <div class="product-item-link"><a href="#">GPS Topcon GR-3</a></div>
                                            <div class="product-item-description">
                            ...
                            <div class="show_more">
                                <a href="#">
                                    <div class="show_more_img">
                                        <img src="images/show_more_icon.png" alt="">
                                    </div>
                            ...
                            <div class="katalog_brends_seo">
                                <p>Теодолит электронный позволяет автоматизировать процесс угловых измерений. На нашем сайте вы можете купить теодолит для самых различных нужд, при этом стоит отметить, что ведущие производители геодезического оборудования, такие как Topcon, Sokkia, Leica и другие, выпускают ограниченное количество оптических и массово производят электронные теодолиты. Цена электронного теодолита приравнивается к стоимости их оптических собратьев. В настоящее время фирмами-производителями выпускается широкий спектр теодолитов, начиная от высокоточных, обеспечивающих точность измерений 1-2 секунды и заканчивая техническими теодолитами, имеющими угловую точность 15-30 секунд. В таких приборах применяют не традиционную систему снятия отчетов по градусам, минутам, секундам, а, например, двоичную систему. То есть, угол представляется в двоичном коде исчисления, при этом лимб делят на чередующиеся черные и белые полосы. При просвечивании этих полос возникает два сигнала (0 и 1), которые автоматически записываются и обрабатываются. Такая система обозначений позволяет уменьшить поток информации и автоматически ввести ее в вычислительное устройство теодолита.</p>
                                <p>Теодолиты электронные в отличие от оптических - просты в работе, не требуют визуального снятия отсчетов. Чтобы получить значения углов, достаточно просто навестись на цель и на дисплее отобразятся результаты. Таким образом, исключаются ошибки при снятии отсчетов, и, следовательно, повышается эффективность производства и качество работ. Все эти приборы имеют цилиндрический уровень, который используется для приведения прибора в рабочее положение. Кроме того, большинство приборов снабжено датчиком угла наклона, который автоматически компенсирует наклон вертикальной оси. Современные электронные теодолиты имеют прочный водонепроницаемый корпус, что позволяет работать с геодезическими приборами при неблагоприятных погодных условиях и в условиях сильной запыленности. Стандартная рабочая температура от -20?С до +50?С. Для работы с ними не обязательно нанимать высококвалифицированного работника. Независимо от того, взяли ли вы прибор напрокат, или решили купить теодолит, оператору достаточно знать основы геометрии из школьного курса.</p>
                                <p>Пожалуй, один недостаток, все-таки есть. Работа с теодолитом требует своевременной подзарядки аккумуляторов прибора. В защиту можно сказать, что практически все современные геодезические приборы снабжены функцией энергосбережения, выключающую прибор автоматически.
 в зависимости от того, на какое время установлен таймер. А благодаря внедрению современных технологий продолжительность работы одного алкалинового аккумулятора С-типа (в стандартном комплекте геодезического </p>
                            </div>
                        </div>
                    </div>
                </div>
